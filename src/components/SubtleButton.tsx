...
export const SubtleButton: FunctionComponent<ButtonProps> = ({
  children,
  className,
  stretchOnMobile,
  ...props
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M20.5917 0H269.408L290 18L269.408 36H20.5917L0 18L20.5917 0Z"
          fill="#1E1E1E"
        />
      </svg>
      ...
      >
        <path
          d="M0.758236 18L20.7089 0.5H268.291L288.242 18L268.291 35.5H20.7089L0.758236 18Z"
          stroke="#B28538"
        />
      </svg>
      ...
      >
        <path
          d="M0.600925 18L12.2676 0.5H156.732L168.399 18L156.732 35.5H12.2676L0.600925 18Z"
          stroke="#B28538"
        />
      </svg>
