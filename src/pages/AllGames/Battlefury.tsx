  ...
  return (
    ...
    >
      ...
      <div className="absolute left-[12.5%] top-[90vh] w-[40%] space-y-5 z-[100]">
        <h1 className="text-xl md:text-5xl text-primary font-bold">{t('battlefury_subtitle1')}</h1>
        <h1 className="text-xl md:text-5xl text-primary font-bold">{t('battlefury_subtitle2')}</h1>
        <p className=" text-base text-secondary md:text-xl">{t('games.battle.desc')}</p>
      </div>
      ...
      <div className="relative w-full h-auto py-10 -mb-20 md:mb-0">
        ...
        >
          <h2 className="text-primary md:text-3xl text-2xl font-bold">{t('overview')} :</h2>
