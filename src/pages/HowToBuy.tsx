    ...
    >
      ...
      <div className="flex max-w-[1100px] w-full gap-11 lg:min-h-fit min-h-screen mx-auto mt-3 md:mt-6 text-secondary md:pb-20 px-5 lg:flex-row flex-col items-center lg:items-start">
        ...
        <div className="w-full lg:max-h-96 lg:overflow-y-scroll ">
          <div className="">
            <h1 className="text-primary font-bold sm:text-5xl text-4xl">
              {t("buy.step")} #1
            </h1>
          ...
          <div className="text-lg sm:text-xl space-y-6">
            <h1 className="text-primary font-bold  sm:text-5xl text-4xl mt-7">
              {t("buy.step")} #2
            </h1>
            {(t("buy.step2", { returnObjects: true }) as stepInterface[]).map(
              ({ title, value }) => (
          ...
          <div className="text-lg sm:text-xl space-y-1">
            <h1 className="text-primary font-bold  sm:text-5xl text-4xl mt-7 mb-6">
              {t("buy.step")} #3
            </h1>

            {(t("buy.step3", { returnObjects: true }) as string[]).map(
              (items, i) => (
                <div className="flex gap-1 font-medium" key={i}>
                  <p className="">{i + 1}.</p>
                  <p className="">{items}</p>
