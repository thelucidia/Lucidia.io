    ...
    <section className="w-full h-auto pt-10 sm:pt-20 lg:pt-12 lg:pb-16 bg-[#171717] relative flex items-center font-primary text-secondary px-5">
      <div className="md:w-[75%] w-fit mx-auto flex flex-col">
        ...
        <div className="pt-8 grid md:grid-cols-2 grid-cols-1 gap-x-12 2 gap-y-8 justify-items-stretch">
          <Images defaultSrc="/games/zombie_outbreak.png" hoverSrc="/games/zombie_outbreak2.png" />
          <Images defaultSrc="/games/lucidcraft.png" hoverSrc="/games/lucidcraft2.png" />
          <Images defaultSrc="/games/battlefury.png" hoverSrc="/games/battlefury2.png" />
          <Images defaultSrc="/games/canyon_drift.png" hoverSrc="/games/canyon_drift2.png" />
        </div>
      </div>
    </section>
  );
