    ...
    <section className="w-full h-auto mt-10 pt-10 sm:pt-20 lg:pt-12 lg:pb-16 relative flex items-center font-primary text-secondary px-5">
      <div className="md:w-[82%] mx-auto flex flex-col">
        ...
        <div className="mt-8 w-full grid grid-cols-1 xl:grid-cols-2 gap-8">
          <div>
            <img src={`/free/news${index + 1}.png`} className="w-full" />
            <div className="mt-4">
              ...
              <div className="mt-6 text-xl">{t(`news_title${index}`)}</div>
            </div>
          </div>

          <div className="xl:grid-cols-3">
            <div className="w-full md:flex gap-4 items-start mb-14">
            ...
            <div className="w-full mt-4 md:flex gap-4 items-start mb-14">
