        ...
        <div className="w-full h-auto sm:clipped2 bg-prpl relative flex items-center justify-center scale-x-[-1]">
          <div className="w-full h-full scale-x-[-1]">
            ...
            <div className="flex flex-wrap justify-center">
              <div className="max-w-[370px] mb-2">
                <img src="/partners/lucidia.jpg" className="w-full h-full" alt="partner" />
              </div>
              <div className="flex-1 flex flex-col gap-y-6">
                ...
                <p className="text-[16px] px-12 m-auto text-center">{t('partners_desc')}</p>
              </div>
            </div>
          </div>
        </div>
