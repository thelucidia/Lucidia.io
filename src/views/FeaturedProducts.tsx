...
const FeaturedProducts = () => {
  ...
  // };
  return (
    <section className="w-full h-auto mt-10 pt-10 sm:pt-20 lg:pt-12 lg:pb-16 bg-[#171717] relative flex items-center font-primary text-secondary px-5">
      <div className="md:w-[75%] w-fit mx-auto flex flex-col">
        <h1 className="font-bold text-2xl sm:text-2xl md:text-3xl">
          {t("featured_products")}
        </h1>
        <div className="pt-12 grid md:grid-cols-2 xl:grid-cols-4 grid-cols-1 gap-x-12 2 gap-y-8 justify-items-stretch">
          <ProductCard
